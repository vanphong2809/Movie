<%-- 
    ...
    Created on : Jan 3, 2020, 2:15:41 PM
    Author     : Admin
--%>
...
<html>
    <head>
        ...
        <link href="css/select-seat.css" rel="stylesheet" type="text/css" />
        <link href="/Movie/jsp/css/jquery.seat-charts.css" rel="stylesheet" type="text/css" media="all" />
        <script src="/Movie/jsp/js/jquery-1.11.0.min.js"></script>
        <script src="/Movie/jsp/js/jquery.seat-charts.js"></script>
    </head>
    <body>
        <div class="content">
        ...
        <script src="/Movie/jsp/js/jquery.nicescroll.js"></script>
        <script src="/Movie/jsp/js/scripts.js"></script>
    </body>
</html>
