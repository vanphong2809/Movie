<%-- 
    Document   : Menu
    Created on : Jan 4, 2020, 8:53:53 PM
    Author     : Admin
--%>
...
<div id="sidebar" class="sidebar responsive">
            ...
            <ul class="submenu">
                <li class="">
                    ...
                    <ul class="submenu">
                        <li class="">
                            <a
                                href="<%=request.getContextPath()%>/MovieAD.htm">
                                <i class="menu-icon fa fa-caret-right"></i>
                                Danh sách sản phẩm
                            </a>
                            <b class="arrow"></b>
                        ...
                        <li class="">
                            <a href="<%=request.getContextPath()%>/initInsertMovie.htm">
                                <i class="menu-icon fa fa-caret-right"></i>
                                Thêm mới sản phẩm
                            </a>
                            <b class="arrow"></b>
    ...
    <div class="sidebar-toggle sidebar-collapse" id="sidebar-collapse">
        ...
        <i class="ace-icon fa fa-angle-double-left" data-icon1="ace-icon fa fa-angle-
